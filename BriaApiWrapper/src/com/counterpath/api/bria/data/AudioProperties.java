...
public class AudioProperties {
	...
	public AudioProperties(boolean microphoneMuted, boolean speakerMuted,
			boolean speakerModeEnabled, int speakerVolume, int microphoneVolume) {
		this.microphoneMuted = microphoneMuted;
		this.speakerMuted = speakerMuted;
		this.speakerModeEnabled = speakerModeEnabled;
	...
	public void setSpeakerModeEnabled(boolean speakerModeEnabled) {
		this.speakerModeEnabled = speakerModeEnabled;
	}
